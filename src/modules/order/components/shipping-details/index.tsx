...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">Giao hàng</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Địa chỉ</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Phương thức giao hàng</h3>
        <div>
